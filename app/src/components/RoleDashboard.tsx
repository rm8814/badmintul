...
export default function RoleDashboard({ role, children }: { role: Role; children: ReactNode }) {
  ...
  return <AppShell role={role}><main className="px-4 py-8 sm:px-8 sm:py-10"><div className="content-container flex flex-col items-stretch justify-start gap-8">{children}</div></main></AppShell>
}
