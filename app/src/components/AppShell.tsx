...
const roleNav: Record<Role, { label: string; href: string }[]> = {
  ...
  superadmin: [{ label: 'Approval queue', href: '/admin' }, { label: 'Metrics', href: '/admin/metrics' }, { label: 'Venues', href: '/admin/venues' }, { label: 'Users', href: '/admin/users' }, { label: 'All Bookings', href: '/admin/bookings' }, { label: 'Settings', href: '/admin/settings' }, { label: 'View As', href: '/admin/view-as' }, { label: 'View As Log', href: '/admin/view-as-log' }],
}
