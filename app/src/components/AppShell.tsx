...
import { BuildingIcon, CalendarIcon, ChartBarIcon, ChartPieIcon, ClipboardCheckIcon, ClockIcon, CogIcon, CompassIcon, DocumentListIcon, EyeSwitchIcon, UsersIcon } from './ui/icons'

type Role = 'player' | 'venueOwner' | 'superadmin'

export function shouldInertSidebar(isDesktop: boolean, isNavOpen: boolean) {
  return !isDesktop && !isNavOpen
}
...
const roleNav: Record<Role, NavItem[]> = {
  player: [
    { label: 'Browse courts', href: '/player', icon: CompassIcon },
    { label: 'My Bookings', href: '/player/bookings', icon: CalendarIcon },
  ],
  venueOwner: [
    { label: 'Venue overview', href: '/venue-owner', icon: BuildingIcon },
    { label: 'Bookings', href: '/venue-owner/bookings', icon: CalendarIcon },
    { label: 'Availability', href: '/venue-owner/availability', icon: ClockIcon },
    { label: 'Stats', href: '/venue-owner/stats', icon: ChartBarIcon },
  ],
  superadmin: [
    { label: 'Approval queue', href: '/admin', icon: ClipboardCheckIcon },
    { label: 'Metrics', href: '/admin/metrics', icon: ChartPieIcon },
    { label: 'Venues', href: '/admin/venues', icon: BuildingIcon },
    { label: 'Users', href: '/admin/users', icon: UsersIcon },
    { label: 'All Bookings', href: '/admin/bookings', icon: CalendarIcon },
    { label: 'Settings', href: '/admin/settings', icon: CogIcon },
    { label: 'View As', href: '/admin/view-as', icon: EyeSwitchIcon },
    { label: 'View As Log', href: '/admin/view-as-log', icon: DocumentListIcon },
  ],
}
